...
<body>
    ...
    <div id="area_cabecalho"><!--cabecalho -->
        <div id="area_logo"><!-- logo-->
            <h1 id="cor_logo">Sua<span style="color: #F2F2F2;">Medida</span></h1>
        </div>
        <nav>
            <a href="index.php">Roupas</a>
            <a href="processa_cadastro.php">Cadastre-se</a>
        </nav>
    </header>
    ...
    <div id="section3" class="container-fluid bg-secondary text-white" style="padding:100px 20px;">
     <h1>Login</h1>
        <form action="processa_login.php" method="POST">
            ...
            <button type="button" class="btn btn-secondary" onclick="window.location.href='redefinir_senha.php?token=seuTokenAqui'">Redefinir Senha</button>
